...
Two subcommands:
    python3 scripts/perf_audit_v6.py data <command>   — fetch raw BQ data as JSON
    python3 scripts/perf_audit_v6.py render ...        — fetch data + render markdown skeleton
"""
...
def render_main(argv=None):
    ...
    from scripts.perf_audit_engine_v6.render.audit_skeleton import render_audit

    parser = argparse.ArgumentParser(prog="perf_audit_v6 render")
